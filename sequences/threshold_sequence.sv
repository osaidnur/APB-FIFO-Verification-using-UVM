//------------------------------------------------------------------------------
// Threshold Sequence - Tests almost full/empty thresholds
//------------------------------------------------------------------------------
class threshold_sequence extends apb_base_sequence;
  ...
  task body();
    ...
    for (int i = 0; i < 5; i++) begin
      ...
      `uvm_info("SEQ", $sformatf("Count=%0d, almost_empty=%0d", i+1, almost_empty), UVM_HIGH)
    end
    ...
    for (int i = 5; i < FIFO_DEPTH; i++) begin
      ...
      `uvm_info("SEQ", $sformatf("Count=%0d, almost_full=%0d", i+1, almost_full), UVM_HIGH)
    end
